...
// since clicking something on the server does not make sense, mostly hooks aye toh use client on the component
// means wont come on the html file generated by the server

import ButtonComponent from "./Button";

// so takes away the SEO optimization
